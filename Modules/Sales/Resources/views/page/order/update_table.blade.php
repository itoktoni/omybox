    ...
    <tbody>
        ...
        <tr>
            ...
            <td data-title="Ongkir">
                <input type="text" name="brand[{{ $brand->item_brand_id }}][temp_brand_ongkir]" required
                    placeholder="Ongkir" class="form-control text-right number temp_qty"
                    value="{{ $brand->sales_order_detail_ongkir ?? '' }}">
            </td>
